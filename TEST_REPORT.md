...
- Local result: 268 tests passed with 85.14% branch-aware coverage. Ruff and
  mypy passed. No Yellow deployment or real-camera test was performed for this
  follow-up; prior Milestone 7 panel evidence below is retained as historical
  evidence and is not a claim about the current UI.
