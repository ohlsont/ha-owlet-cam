...
- The helper result schema does not yet report direct/relay session mode. MCP
  ...
  probe behavior and session-mode observation are therefore still required
  before the complete Milestone 4 gate can be marked passed.
