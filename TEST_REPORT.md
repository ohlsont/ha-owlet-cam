...
| 5–8 — Snapshot through stable release | — | — | — | — | — | — | — | Unperformed | Unperformed | Unperformed | Milestone 5 may begin; no implementation yet | — | All snapshot, camera-entity, continuous-stream, outage and release gates | Milestone 4 is no longer the blocker; external bridge and HACS-publication work remain separately deferred by user |
